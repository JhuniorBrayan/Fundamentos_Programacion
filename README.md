...
### 1. Teoría
Contiene explicaciones detalladas de los conceptos básicos de la programación. Dentro de esta carpeta se encuentran las siguientes subcarpetas:

- **ejemplo/**: Código ilustrativo para comprender cada tema.
- **ejercicios/**: Problemas propuestos para practicar.
- **soluciones/**: Soluciones explicadas a los ejercicios.
...
├── 3-estructuras-datos/
│   ├── arrays-listas.md
│   ├── diccionarios-mapas.md
│   ├── pilas-colas.md
│   ├── conjuntos.md
│   └── estructuras-complejas.md
│
├── 4-programacion-orientada-objetos/
│   ├── clases-objetos.md
│   ├── herencia.md
